import { ConfirmRegisterEmailController } from "../../../../src/adapters/presentation/controllers/user";
import { RegisterEmailConfirmation }
...
import Errors
	from "../../../../src/application/usecases/user/RegisterEmailConfirmation/Errors";
...
describe("Unit Tests Of ConfirmRegisterEmailController", () => {
	...
	it('should be able to call correctly applications functions', async () => {
		...
		const controller = new ConfirmRegisterEmailController(fakeConfirmEmailLink);
