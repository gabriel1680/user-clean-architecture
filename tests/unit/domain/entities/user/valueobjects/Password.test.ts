import { InvalidPasswordError } from "../../../../../../src/domain/entities/user/errors";
import { Password } from "../../../../../../src/domain/entities/user/valueobjects"


describe("Unit Tests of Password Value Object", () => {
    it("Should be able to create an instance", () => {
        const passwordValidValues = ["12345", "123456", "1234567", "123456789", "12345678910"];
    ...
    it("Should not be able to instanceate by receiving empty password", () => {
        ...
        return expect(attemptToCreateEmptyPassword).toThrow(InvalidPasswordError);
    });
    ...
    it("Should not be able to instanceate by receiving an password with less than 5 characters", () => {
        ...
        return expect(attemptToCreateWrongPassword).toThrow(InvalidPasswordError);
    });
});