...
import UserDoesNotExistsError from "../shared/errors/UserDoesNotExistsError";
...
export default class AuthenticateUserByToken implements UserTokenAuthenticator {
	...
	public async execute(token: string): Promise<DomainError | ApplicationError | void> {
